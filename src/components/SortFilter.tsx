        ...
        return (
          <button
            ...
            className={`flex w-fit cursor-pointer items-center gap-1.5 rounded-full border px-4 py-1.5 text-sm font-medium transition-colors ${
              active
                ? "border-accent-500 bg-search-background-pink text-accent-800 dark:border-gray-500 dark:bg-surface-2 dark:text-gray-100"
                : "border-gray-200 bg-white text-gray-500 hover:bg-gray-50 dark:border-surface-3 dark:bg-surface-1 dark:text-gray-400 dark:hover:bg-surface-2"
            }`}
          >
