  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm md:p-8">
        <h1 className="border-b border-gray-100 pb-4 text-xl font-bold text-gray-900">설정</h1>

        <div className="mt-6 flex flex-col gap-8">
          {/* 알림 설정 */}
          <div className="flex flex-col gap-3">
            <h2 className="text-sm font-semibold text-gray-500">알림 설정</h2>
            <Toggle name="friend" title="친구 신청 알림" description="친구 신청 알림을 받습니다" defaultChecked={notif.friend} />
            <Toggle name="event" title="이벤트 시작 알림" description="공연 시작 1시간 전 알림을 받습니다" defaultChecked={notif.event} />
            <Toggle name="marketing" title="마케팅 알림" description="이벤트 및 프로모션 정보를 받습니다" defaultChecked={notif.marketing} />
          </div>
      ...
      <section className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm md:p-8">
        ...
        <ul className="flex list-disc flex-col gap-2 pl-5 text-sm text-gray-500">
          <li>알림 설정에서 친구 신청 및 이벤트 관련 알림 수신 여부를 변경할 수 있습니다</li>
          <li>원하는 알림만 선택하여 받아볼 수 있으며, 알림 수신 여부는 언제든지 변경할 수 있습니다</li>
