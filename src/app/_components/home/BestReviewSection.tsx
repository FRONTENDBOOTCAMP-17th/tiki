...
export default function BestReviewSection({
  ...
  return (
    <section className="bg-gray-50 px-4 py-8 md:px-8 lg:px-16">
      <div className="mx-auto w-full max-w-7xl">
        <h2 className="mb-4 text-lg font-bold tracking-tight text-gray-950 md:text-xl">
          베스트 리뷰
        </h2>
          ...
          {reviews.map((review) => (
            <li key={review.reviewId}>
              <Link
                ...
                className="group flex h-full gap-4 rounded-xl border border-gray-200 bg-white p-4 transition duration-200 hover:-translate-y-1 hover:scale-[1.01] hover:border-primary-300 hover:shadow-sm"
              >
                <div className="relative aspect-3/4 w-20 shrink-0 overflow-hidden rounded-lg bg-primary-100 shadow-sm">
                  <ThumbnailImage
