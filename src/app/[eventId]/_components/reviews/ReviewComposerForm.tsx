    ...
    <div className="flex flex-col gap-4 px-5 py-4">
      <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_220px]">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex h-10 items-center gap-2">
            ...
            />
            <span className="min-w-16 text-sm font-medium text-gray-700">
      ...
      <div className="flex min-w-0 flex-col gap-2">
        <div className="flex items-center justify-between gap-3">
          <label className="text-sm font-semibold text-gray-800">후기</label>
        ...
        <textarea
          ...
          className="min-h-24 resize-none rounded-lg border border-gray-200 bg-gray-50 px-3 py-3 text-sm leading-relaxed outline-none transition-colors placeholder:text-gray-400 focus:border-primary-400 focus:bg-white focus:ring-2 focus:ring-primary-100"
        />
