    ...
    <form onSubmit={onSubmit} className="mx-auto max-w-7xl space-y-6 py-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_300px]">
          ...
          <SectionCard step={2} title="공연 일정">
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                {rangeDates.size === 0 ? (
                  <div className="flex min-h-52 items-center justify-center rounded-xl border border-dashed border-gray-200 px-4 text-center text-sm text-gray-400 dark:border-surface-3 dark:bg-surface-2 dark:text-gray-500">
                    공연 기간을 먼저 선택하면
                    <br />
                    제외할 날짜를 고를 수 있어요
                  </div>
        ...
        <aside className="flex h-fit flex-col gap-4 lg:sticky lg:top-10">
          <div className="flex flex-col gap-3 rounded-2xl border border-gray-200 bg-white p-6 dark:border-surface-3 dark:bg-surface-1">
