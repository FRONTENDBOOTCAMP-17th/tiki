...
export default function Notice({
  ...
  return (
    <div className="flex h-fit w-full flex-col gap-3 rounded-xl bg-gradient p-5 md:gap-4 md:rounded-2xl md:p-8 dark:border dark:border-[#3c4043] dark:bg-none dark:bg-[#2a2b2f]">
