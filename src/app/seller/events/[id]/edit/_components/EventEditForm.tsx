...
const inputClass =
  "rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 outline-none focus:border-primary-500 dark:border-surface-3 dark:bg-surface-2 dark:text-gray-100 dark:placeholder:text-gray-500 dark:focus:border-gray-500";
  ...
  return (
    <form onSubmit={onSubmit} className="mx-auto max-w-3xl space-y-6 py-6">
      ...
      <SectionCard step={3} title="회차 시간">
        <div className="mb-4 flex flex-wrap items-center gap-x-4 gap-y-1 rounded-xl bg-gray-50 px-4 py-3 text-sm text-gray-500 dark:bg-surface-2 dark:text-gray-400">
          <span>
            공연 기간{" "}
          ...
          <>
            ...
            <div className="max-h-112 space-y-3 overflow-auto pr-1">
              {Object.entries(slotsByDate).map(([date, slots]) => (
                <div key={date} className="rounded-xl border border-gray-100 p-4 dark:border-surface-3">
                      ...
                      return (
                        ...
                        >
                          ...
                          <input
                            ...
                            className={`${inputClass} disabled:bg-gray-50 dark:disabled:bg-surface-1 ${isRemoved ? "line-through" : ""}`}
                          />
                          {run > 0 && (
                          ...
                          <div className="ml-auto">
                            {orders > 0 ? (
                              <span className="rounded-md bg-gray-100 px-2 py-1 text-xs text-gray-500 dark:bg-surface-2 dark:text-gray-400">
                                예매 {orders}건
                              </span>
                            ) : isRemoved ? (
                              <button
      ...
      <div className="sticky bottom-0 flex justify-end gap-3 rounded-2xl border border-gray-200 bg-white/90 p-4 backdrop-blur dark:border-surface-3 dark:bg-surface-header/90">
        <Button
